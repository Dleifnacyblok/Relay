          ...
          <div className="px-6 py-8 flex flex-col items-center text-center gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed max-w-xs">
                Get a guided walkthrough of <strong>My Loaners</strong>, <strong>Missing Parts</strong>, <strong>Marketplace</strong>, <strong>Track Log</strong>, and <strong>My Account</strong> — with detailed explanations at every step.
              </p>
            </div>
