...
import { createDoc, addReportHeader, addFooters, drawLoanerRow, checkPageBreak, getNow, getFilename } from "@/lib/pdfUtils";
    ...
    setTimeout(() => {
      try {
        ...
        for (const l of filtered) {
          ...
          y = drawLoanerRow(doc, { loaner: l, y, pageWidth, margin });
        }

        addFooters(doc);
        doc.save(getFilename("my-loaners"));
        onClose();
      } finally {
